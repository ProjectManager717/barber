            ...
            .then(response => {
                ...
                if (response.ResultType === 1) {
                    ...
                    this.setState({
                        ...
                        totalTips: parseFloat(Data.weekly_tips),
                        //totalRevenue: total,
                    });
                    ...
                    this.setState({chartData: chartdata, chartLabels: chartlabels},()=>{
                        if(Data.Stripe_Current_Balance!=false)
                        {
                            ...
                            console.log("balancee amountAvailable",total)
                            console.log("balancee totalpending",totalpending)
    ...
    cashOut() {
        if (parseInt(this.state.totalRevenue) > 0) {
            ...
            var details = {
                ...
                amount: parseFloat(this.state.totalRevenue)*100,
            };
            var formBody = [];
            ...
            />*/}
                ...
                <View style={styles.allBoxes}>
                    <View style={styles.boxContainer}>
                        ...
                        <View style={[styles.smallBox, { width: width / 3.25 }]}>
                        ...
                        <View style={[styles.smallBox, { width: width / 3.25 }]}>
                            ...
                            <View style={{ marginLeft: 3 }}>
                                ...
                                <Text style={{color: colors.white,
                                    ...
                                    textAlign:"left"
                                }}>${this.state.totalTips > 0 ? this.state.totalTips.toFixed(2) : 0}</Text>
                            </View>
                        </View>
                    </View>
                    <View style={styles.largeBox}>
                        ...
                        <View style={{ flex: 1, marginLeft: 10 }}>
                            ...
                            <Text style={[styles.label, {
                                fontWeight: 'bold',
                                fontSize: 15
                            }]}>${this.state.totalRevenueInAccount>0?this.state.totalRevenueInAccount.toFixed(2):0}</Text>
                        </View>
                    </View>
                    <View style={styles.largeBox}>
                        <Image source={require("../../assets/images/dollar.png")}
                        ...
                        <View style={{ flex: 1, marginLeft: 10 }}>
                            ...
                            <Text style={[styles.label, {
                                fontWeight: 'bold',
                                fontSize: 15
                            }]}>${this.state.totalRevenue>0?this.state.totalRevenue.toFixed(2):0}</Text>
                        </View>
