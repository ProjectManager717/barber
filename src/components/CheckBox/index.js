...
export default class CheckBox extends Component {
    ...
    _renderImage() {
        ...
        if (this.props.isChecked) {
            ...
            return  <Image source={require("../../assets/images/ic_checkbox_false.png")} style={{height:16,width:16,tintColor: this._getTintColor()}}/>;
        }
    }
    ...
    genCheckedImage() {
        if(this.props.checkedImage == null){
            return  <Image source={require("../../assets/images/ic_checkbox_true.png")} style={{height:16,width:16,tintColor: this._getTintColor()}}/>;
        }
