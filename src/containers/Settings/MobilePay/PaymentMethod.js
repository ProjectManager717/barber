...
export default class PaymentMethod extends Component {
        ...
        this.setState({showLoading: true});
         if (this.state.isConnected) {
             ...
             if (this.state.params.number === "" || this.state.params.number.length < 16 ||
                 this.state.params.expMonth === null || this.state.params.expYear === null || this.state.params.cvc === "" || this.state.params.name === "") {
    ...
    selected(index){
     let CardDataTemp = this.state.CardData
        ...
        this.setState({CardData:CardDataTemp},()=>{
