...
export default class DiscoverMePaymentMethod extends Component {
...
/*        client_id = navigation.getParam('client_id');
    ...
    CardList(){
        if (this.state.isConnected) {
            ...
            fetch(constants.BarberCardList, {
                method: 'POST',
                headers: {
    ...
    PaymentFlow(){
        ...
        if (this.state.isConnected) {
            ...
            formBody = formBody.join("&");
            fetch(constants.DiscoverMePaymentMethod, {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/x-www-form-urlencoded'
                ...
                .then(response => {
                    ...
                    if (response.ResultType === 1) {
                       ...
                       alert("Discover Me Payment successful")
    ...
    saveCard = async (shouldPass = true) => {
        ...
        if (this.state.isConnected) {
            if (this.state.params.number === "" || this.state.params.number.length < 16 ||
                ...
                formBody = formBody.join("&");
                fetch(constants.BarberAddPaymentCard, {
                    method: 'POST',
                    headers: {
                        'Accept': 'application/json',
                        'Content-Type': 'application/x-www-form-urlencoded'
    ...
    renderpaymentitems(item,index){
        return <TouchableOpacity onPress={()=>{this.selected(index)}}>
            <View style={{width:"100%",justifyContent:'center',alignItems:'center'}}  >
                <View  style={{width:"100%",height:50,backgroundColor:"white",flexDirection:"row",alignItems:'center',borderBottomWidth:0.5,borderColor:"lightgrey"}}>
                    ...
                    <View style={{flexDirection: "column",width:"100%",height:"100%"}}>
                        <View style={{width: "100%"}}>
                            <View style={{width: "100%", flexDirection: "column", alignItems: "center"}}>
                                ...
                                <View style={{width:"100%", height: 200,backgroundColor:"#F2F2F5",justifyContent:'center',alignItems:'center',}}>
                                    <View  style={{width:190, height:120,borderWidth:2,borderRadius:15,justifyContent:'center',alignItems:'center',borderColor:"#56A5FC"}}>
                                        <View  style={{width:180,height:110,borderWidth:0.5,borderRadius:10,borderColor:"#56A5FC"}}  >
                                            <View style={{width:30,height:30,backgroundColor:"#56A5FC",borderRadius:5,opacity:0.4,marginStart:5,marginTop:5}}/>
                                            <View style={{width:"100%",justifyContent:'center',alignItems:'center',marginTop:45,flexDirection:"row"}} >
                                                <Text style={{fontSize:7,fontWeight:'bold',color:'#56A5FC'}}  >{'\u2B24'+" "+'\u2B24'+" "+'\u2B24'+" "+'\u2B24'+"  "+'\u2B24'+" "+'\u2B24'+" "+'\u2B24'+" "+'\u2B24'+"  "+'\u2B24'+" "+'\u2B24'+" "+'\u2B24'+" "+'\u2B24'}</Text>
                                                <Text style={{fontSize:12,fontWeight:'bold',color:'#56A5FC'}}  >{" "+this.state.paymentCardLast4Digits}</Text>
                                            </View>
                                        </View>
                        ...
                        <View style={{width:"100%"}}  >
                            ...
                            <TouchableOpacity onPress={()=>this.setState({DialogVisible2:true})} style={{backgroundColor:"white",width:"100%",height:40,flexDirection:'row',alignItems:"center",marginTop:40}}  >
                                ...
                                <View style={{width: "100%", flexDirection: "row"}}>
                                        ...
                                        <PopupDialog
                                            ...
                                            <View style={{flexDirection: "column", alignItems: "center"}}>
                                                ...
                                                <Text style={{
                                                    ...
                                                    Month</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:1} , DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>01</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:2}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>02</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:3}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>03</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:4}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>04</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:5}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>05</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:6}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>06</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:7}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>07</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:8}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>08</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:9}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>09</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:10}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>10</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:11}, DialogVisible: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>11</Text>
                                                <Text onPress={() => this.setState({params:{ ...this.state.params,  expMonth:12}, DialogVisible: false})}
                                                      style={{
                                                          fontSize: 18,
                                                          marginTop: 20,
                                                          color: "black",
                                        ...
                                        <PopupDialog
                                            ...
                                            <View style={{flexDirection: "column", alignItems: "center"}}>
                                                ...
                                                <Text style={{
                                                    ...
                                                    Year</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:19}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2019</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:20}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2020</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:21}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2021</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:22}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2022</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:23}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2023</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:24}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2024</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:25}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2025</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:26}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2026</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:27}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2027</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:28}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2028</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:29}, DialogVisible1: false})}
                                                      style={{fontSize: 18, marginTop: 20, color: "black"}}>2029</Text>
                                                <Text onPress={() => this.setState({params:{...this.state.params,expYear:30}, DialogVisible1: false})}
                                                      style={{
                                                          fontSize: 18,
                                                          marginTop: 20,
                                                          color: "black",
                                    ...
                                    <View style={[styles.row_back, {width: "25%"}]}>
                                        <TextInput style={{fontSize: 15, color: 'white', marginStart: 5,width:"80%"}}
                                                   placeholder={"123"}
                                                   onChangeText={(text) => this.setState({params:{...this.state.params ,cvc:text}})}
                                                   placeholderTextColor={"grey"}/>
                                    </View>
                                </View>
                                ...
                                <View style={{ flexDirection: 'column', width: "100%"}}>
                                    <View style={{flexDirection: "row", alignItems: "center",}}>
                                        <TextInput
                                            ...
                                            onChangeText={(text) => this.setState({params:{...this.state.params, name:text}})}
                                            placeholderTextColor={"grey"}
                                        />
                                    </View>
                        ...
                        {this.state.pay &&  <TouchableOpacity onPress={()=>this.PaymentFlow()} style={[globalStyles.button, {
                            marginTop: 40,
                            height: 35,
                            width: 260,
                            marginBottom: 30
