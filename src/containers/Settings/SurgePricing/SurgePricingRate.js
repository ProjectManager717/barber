...
let client_id,
    ...
    total_price=0,
    service_fee,
    selected_surge_price, barberMobilePay, surgeprice=0,tip_price=0;
                    ...
                    <View style={{ flexDirection: "column", alignItems: "center" }}>
                        <View style={[styles.row, { marginTop: 20, width: '100%' }]}>
                            <Text style={[{ textAlign: "center", color: "white", fontWeight: "bold", fontSize: 13 }]}>
                                {
                                    'Your price on this session\n' +
                                    'will be higher than normal,when\n' +
                                    'demand is high we increase the rates.'
                                }
                            </Text>
                        </View>
                        ...
                        <View style={{ alignItems: "center", flexDirection: "column" }}>
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <Text style={{ fontSize: 14, fontWeight: "bold", color: "white", width: '100%', textAlign: 'center' }}>Accept Higher Rate</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => {
                                this.props.navigation.goBack();
                            }} style={[globalStyles.button, {
                                ...
                                <Text style={{ fontSize: 14, fontWeight: "bold", color: "white", width: '100%', textAlign: 'center' }}>Cancel</Text>
                            </TouchableOpacity>
