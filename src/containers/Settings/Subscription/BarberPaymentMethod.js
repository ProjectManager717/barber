...
let cus_stripe_id, transaction_id, balance_transaction, destination, destination_payment, source_transaction,
    stripedate, created;
export default class BarberPaymentMethod extends Component {
                ...
                .then(response => {
                    ...
                    if (response.ResultType === 1) {
                        ...
                        this.setState({CardData: allCards}, () => {
                            console.log("AllcardsData--", JSON.stringify(this.state.CardData[0]))
    ...
    DeleteCard() {
        ...
        var details = {
            barberEmail: Preference.get("userEmail"),
            barberCard: this.state.selectedCardData.cardInfo.id
        };
        ...
        formBody = formBody.join("&");
        fetch(constants.BarberDeleteCard, {
            method: 'POST',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/x-www-form-urlencoded'
